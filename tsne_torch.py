...
parser.add_argument("--xfile", type=str, default="logs/tsne/penultimate/fusion/pts_fea.npy", help="file name of feature stored")
parser.add_argument("--yfile", type=str, default="logs/tsne/penultimate/fusion/labels.npy", help="file name of label stored")
parser.add_argument("--cuda", type=bool, default=True, help="if use cuda accelarate")
...
if __name__ == "__main__":
    ...
    color = np.fliplr(np.array(color)) / 255

    plt.figure(figsize=(8, 8))
    plt.scatter(Y[:, 0], Y[:, 1], c=color[labels])
    plt.axis('off')
    plt.show()
